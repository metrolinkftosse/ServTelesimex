 ...
 * @author marav
 */
public class LeerRemotoTCPMicrostar {
    ...
    public LeerRemotoTCPMicrostar(EMedidor med, boolean perfil, boolean eventos, boolean registros, boolean lconfhora, boolean lacumulados, boolean ldisconnect, boolean lreconnect, int indx, boolean aviso, ControlProcesos cp, Abortar objabortar, String usuario, ZoneId zid, long ndesfase) throws InterruptedException{
        this.med = med;
        this.cp = cp;
    ...
    private void init() throws InterruptedException {
        ...
        epp.setRangoEnIntervalos(192);
        DLMS_PrincipalOBIS = new ArrayList<>();
        epp.editDLMS_PrincipalOBIS(0, "0100000000FF"); //Serial
        epp.editDLMS_PrincipalOBIS(2, "0100630101FF"); //perfil - 1
        epp.editDLMS_PrincipalOBIS(3, "0100000003FF"); //Phy Address
        epp.editDLMS_PrincipalOBIS(6, "010063620CFF"); //eventos - Log 1
        ...
        DLMS_PrincipalEvents.add("-"); //down
        DLMS_PrincipalEvents.add("-"); //up
