 ...
 * @author nicol
 */
public class LeerRemotoTCP_Metcom {
    ...
    int InvokeIDandParity = 65; //0x41 := 65
    int indxLength = 2;
    int users[] = {1,2,3,4}; //dirección cliente
    ...
    public LeerRemotoTCP_Metcom(EMedidor med, boolean perfil, boolean eventos, boolean registros, boolean lconfhora, boolean acumulados,  boolean ldisconnect, boolean lreconnect, int indx, boolean aviso, ControlProcesos cp, Abortar objabortar, String usuario, ZoneId zid, long ndesfase) throws InterruptedException{
        this.med = med;
        this.cp = cp;
    ...
    private void init() throws InterruptedException {
        ...
        epp.editDLMS_PrincipalOBIS(12, "0100010800FF"); //Energías Acumuladas
        ...
        byte[] conformance = {(byte) 0x60, (byte) 0xBE, (byte) 0xDD};
        epp.editCamposAARQ("proposedConformance", conformance);
        byte[] maxRxPDUSize = {(byte) 0x04, (byte) 0x00};
        epp.editCamposAARQ("clientMaxRxPDUSize", maxRxPDUSize);
